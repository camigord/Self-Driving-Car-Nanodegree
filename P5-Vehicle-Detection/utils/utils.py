...
# Includes limits both in X and Y axes
def find_cars(img, xstart, xstop, ystart, ystop, scale, svc, X_scaler, pca, orient, pix_per_cell, cell_per_block, hist_bins, color_space, cells_per_step, get_all = False):
